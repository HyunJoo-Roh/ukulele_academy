...
set :application, 'ukulele_academy'
set :repo_url, 'git@github.com:kimpeter/ukulele_academy.git'
set :scm_user, "kimpeter"
...
set :deploy_to, "/home/kimp/www/ukulele_academy"
set :user, "kimp"
